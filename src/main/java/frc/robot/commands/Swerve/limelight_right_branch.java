...
public class limelight_right_branch extends Command {
    public boolean finished;
    private boolean focus;
    private final SwerveSubsystem swerveSubsystem;
    private final Timer timer = new Timer();
            SwerveInputStream driveAngularVelocityKeyboard;
    public limelight_right_branch(SwerveSubsystem swerveSubsystem) {
    ...
    public void execute() {
        ...
        if (focus) {
            ...
            if (timer.hasElapsed(Constants.LIMELIGHT_RIGHT_BRANCH_TIME)) {
                timer.stop();
                this.end(false);
            }
        }
