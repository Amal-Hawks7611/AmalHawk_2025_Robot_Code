...
public final class Constants {
    ...
    public static final double LIMELIGHT_HEIGHT = 0; //cm
    public static final double REEF_APRIL_TAG_HEIGHT = 17; //cm
    public static final double LIMELIGHT_TO_CENTER = 27.7; //cm
    public static final double APRILTAG_TO_BRANCH = 16.5; //cm
    public static final double LM_ALIGN_SPEED_MS = 3; // metre / sn
